...
EEPROM_write_loop:
 ...
 bcf EECON1, 6, A ; ((EECON1) and 0FFh), 6, a These bits allow writing
 bcf EECON1, 7, A ; ((EECON1) and 0FFh), 7, a
 bsf EECON1, 2, A ; ((EECON1) and 0FFh), 2, a
 bcf EECON1, 0, A ; ((EECON1) and 0FFh), 0, a off
 bcf ((INTCON) and 0FFh), 7, a ;Disable global interrupts
 movlw 0x55 ;This is required for some reason
 movwf EECON2, A
 movlw 0xAA
 movwf EECON2, A
EEPROM_wait:
 bsf EECON1, 1, A ; ((EECON1) and 0FFh), 1, a
 btfsc EECON1, 1, A ; ((EECON1) and 0FFh), 1, a
 goto EEPROM_wait
 bsf ((INTCON) and 0FFh), 7, a ;Re-enables global interrupts
...
EEPROM_read_loop:
 ...
 bcf EECON1, 6, A ; ((EECON1) and 0FFh), 6, a These bits allow writing
 bcf EECON1, 7, A ; ((EECON1) and 0FFh), 7, a
 bcf EECON1, 2, A ; ((EECON1) and 0FFh), 2, a off
 bsf EECON1, 0, A ; ((EECON1) and 0FFh), 0, a
 nop
 movf EEDATA, W, A
 movwf POSTINC0, A
 incf FSR1, A
